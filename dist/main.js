...
window.customElements.define('c-element', function (_HTMLElement) {
...
window.customElements.define('c-btn', function (_HTMLElement) {
    _inherits(_class, _HTMLElement);
...
window.customElements.define('c-info', function (_HTMLElement) {
    _inherits(_class, _HTMLElement);
